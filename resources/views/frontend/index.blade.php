		        ...
		        <div class="">
                    ...
                    <div class="owl-carousel">
                            ...
                            <div id="card" class="card">
								<a href="#">
									<div class="campaign_img">
										<img src="resources/views/img/card5.jpg" alt="project image" class="img-responsive"/>
									...
									<!--<h3 class="project-title"> Project : Meenakari-Zentangle Art </h3>-->
									<div class="pad-lr-25">
									<h5 class="author pad-10"> Nura - Headset reinvented for perfect silence...<span> </span> </h5>
										<ul class="list-inline  bdr-btm">
										<li>  Nura Inc.  </li> 
										<li class="pull-right">   New Delhi, DL </li> 								
										</ul>
										<p class="par"> Project description  sed ac orci quis tortor imperdiet venenatis.Duis elementum auctor accumsan.
								        </p>
                        ...
                        <div>
                            <div class="card">
								<a href="{{ route('campaign') }}">
									<img src="resources/views/img/card2.jpg" alt="project image" class="img-responsive"/>
									<!--<h3 class="project-title"> Project : Meenakari-Zentangle Art </h3>-->
									<div class="pad-lr-25">
										<h5 class="author pad-10"> Nura - Headset reinvented for perfect silence...<span> </span> </h5>
										<ul class="list-inline bdr-btm">
										...
										<p class="par"> Project description  sed ac orci quis tortor imperdiet venenatis.Duis elementum auctor accumsan.</p>
										...
										<li> <span class="currency" data-currencyName="inr">1256</span> <p> Pledged </p> </li>  
                        ...
                        <div>
                           <div class="card">
								<a href="#">
									<img src="resources/views/img/card1.jpg" alt="project image" class="img-responsive"/>
									<!--<h3 class="project-title"> Project : Meenakari-Zentangle Art </h3>-->
									<div class="pad-lr-25">
										<h5 class="author pad-10"> Nura - Headset reinvented for perfect silence...<span> </span> </h5>
										<ul class="list-inline bdr-btm">
										...
										<ul class="list-inline card-stage">
										<li>  207% <p> Funded </p> </li> 
										<li> <span class="currency" data-currencyName="inr">204</span> <p> Pledged </p> </li>  
										<li class="pull-right">  32 <p> Days to go </p> </li> 
                        ...
                        <div>
                            <div id="card" class="card">
								<a href="#">
									<div class="campaign_img">
										<img src="resources/views/img/card6.jpg" alt="project image" class="img-responsive"/>
									</div>
									<!--<h3 class="project-title"> Project : Meenakari-Zentangle Art </h3>-->
									<div class="pad-lr-25">
									<a href="campaign.php">	<h5 class="author pad-10"> Nura - Headset reinvented for perfect silence...<span> </span> </h5></a>
										<ul class="list-inline  bdr-btm">
										<li>  Nura Inc.  </li> 
										<li class="pull-right">   New Delhi, DL </li> 								
										</ul>
										...
										<ul class="list-inline card-stage">
										<li>  55% <p> Funded </p> </li> 
										<li>  <span class="currency" data-currencyName="inr">5024</span> <p> Pledged </p> </li>  
										<li>  12 <p> Days to go </p> </li> 
                        ...
                        <div>
                            <div id="card" class="card">
								<a href="#">
									<div class="campaign_img">
										<img src="resources/views/img/card3.png" alt="project image" class="img-responsive"/>
									</div>
									<!--<h3 class="project-title"> Project : Meenakari-Zentangle Art </h3>-->
									<div class="pad-lr-25">
									<a href="campaign.php">	<h5 class="author pad-10"> Nura - Headset reinvented for perfect silence...<span> </span> </h5></a>
