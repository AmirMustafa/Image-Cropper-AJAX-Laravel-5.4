...
<script type="text/javascript">
    function test(getval){
      ...
      if(getval==0){
      window.location.href='camppro1.php';
      }

      if(getval==1){
      window.location.href='preview-campaign.php';
      }
          ...
          <li><a href="{{ route('preview_campaign') }}"> Alps Comics  </a> </li>
			  
			 <!-- <li id="loadMore" onclick ="add();">Show more</li>-->
			
          <li class="divider">  </li>
          <li><a href="profile-page.php"> Profile preview </a></li>
