...
(function( $ ){
	...
	var methods = {
		...
		imageWidget: function(){
			...
			var container = $('<div/>',{'class':"tabbable "});
			var navTabs = $('<ul/>',
									{ class: "nav nav-tabs"
							}).append($('<li/>',
										{ class:"active"
		...
		init : function( options )
		{
			...
			var menuGroups = {'texteffects' : [ 'color', 'bold', 'italics', 'underline'],
							  'aligneffects': ['l_align','c_align', 'r_align', 'justify'],
							  'textformats': ['indent', 'outdent', 'block_quote', 'ol', 'ul'],
							  'fonteffects' : ['styles', 'fonts', 'font_size'],
							  'actions' : ['undo', 'redo'],
							  'insertoptions' : ['insert_link',   'insert_img', 'insert_table'],
							  'extraeffects' : [  'hr_line'],
							  'advancedoptions' : [ 'rm_format',  'source'],
